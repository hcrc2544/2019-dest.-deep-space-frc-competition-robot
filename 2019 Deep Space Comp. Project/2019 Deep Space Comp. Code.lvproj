...
<Project Type="Project" LVVersion="18008000">
	...
	<Property Name="varPersistentID:{02BDB324-25E0-4FCE-AB62-E5B6D4407DD3}" Type="Ref">/Target/Hatch/Hatch Call.vi/Rising Edge Gripper/error out</Property>
	<Property Name="varPersistentID:{08782BF9-6827-4AE9-BB22-0D7D04F9AF12}" Type="Ref">/Target/Drive/Drive Call.vi/One Shot Rising with Input 90/output</Property>
	<Property Name="varPersistentID:{08EA88E7-F9A6-4D7A-9296-30B6B91F9F83}" Type="Ref">/Target/Drive/Drive Call.vi/One Shot Rising with Input 0/error in</Property>
	<Property Name="varPersistentID:{16671BC8-5265-4F7C-9824-407E9AC1360A}" Type="Ref">/Target/Hatch/Hatch Call.vi/Falling Edge Gripper/input</Property>
	<Property Name="varPersistentID:{16B7B6A0-CA32-44A8-B161-A334651B9AFB}" Type="Ref">/Target/Drive/Drive Call.vi/One Shot Rising with Input 270 /error in</Property>
	<Property Name="varPersistentID:{1AEFBE88-1110-41A7-B6B5-F5039F63C70D}" Type="Ref">/Target/Hatch/Hatch Call.vi/Rising Edge Gripper/output</Property>
	<Property Name="varPersistentID:{28425EDA-553F-4076-99D4-6A82380A3AD6}" Type="Ref">/Target/Drive/Drive Call.vi/One Shot Rising with Input  180/error in</Property>
	<Property Name="varPersistentID:{3113F81C-AEF6-4B56-88F9-2CE7C6F1F21B}" Type="Ref">/Target/Hatch/Hatch Call.vi/Falling Edge Gripper/output</Property>
	<Property Name="varPersistentID:{3C71C025-13BC-4D72-B7C3-E74AB9D3FEE5}" Type="Ref">/Target/Drive/Drive Call.vi/One Shot Rising with Input 90/input</Property>
	<Property Name="varPersistentID:{3C92676E-97F0-4D66-B961-D0423C1EFBA1}" Type="Ref">/Target/Drive/Drive Call.vi/One Shot Rising with Input 90/error out</Property>
	<Property Name="varPersistentID:{538F9DD1-F727-441B-8684-2BBED19E6E47}" Type="Ref">/Target/Drive/Drive Call.vi/One Shot Rising with Input 270 /error out</Property>
	<Property Name="varPersistentID:{53A7B740-7E87-47D0-8FAF-4F0FD0AC9B8E}" Type="Ref">/Target/Hatch/Hatch Call.vi/Falling Edge Plate/output</Property>
	<Property Name="varPersistentID:{53B51A24-A719-4B1A-B616-80DBFEA47367}" Type="Ref">/Target/Drive/Drive Call.vi/One Shot Rising with Input 0/input</Property>
	<Property Name="varPersistentID:{5C2FCCAE-9B09-4DF1-838F-FF2814B50835}" Type="Ref">/Target/Hatch/Hatch Call.vi/Rising Edge Gripper/input</Property>
	<Property Name="varPersistentID:{5DCAD4AE-F502-4E29-812B-08E67832537E}" Type="Ref">/Target/Hatch/Hatch Call.vi/Rising Edge Plate/output</Property>
	<Property Name="varPersistentID:{64BA3138-2D68-4F06-BDD9-D3592C77CF41}" Type="Ref">/Target/Drive/Drive Call.vi/One Shot Rising with Input 0/output</Property>
	<Property Name="varPersistentID:{6573C2E6-11E0-4181-AF11-71489877B897}" Type="Ref">/Target/Hatch/Hatch Call.vi/Rising Edge Gripper/error in</Property>
	<Property Name="varPersistentID:{752F5D04-9213-4D3A-8FB4-4BCB15B6354F}" Type="Ref">/Target/Hatch/Hatch Call.vi/Rising Edge Plate/input</Property>
	<Property Name="varPersistentID:{901A97A7-37AB-480D-9F30-FB9F923B2CF0}" Type="Ref">/Target/Hatch/Hatch Call.vi/Falling Edge Gripper/error out</Property>
	<Property Name="varPersistentID:{9B86CE97-909D-4B7C-9BCC-FAC58BD6AE87}" Type="Ref">/Target/Hatch/Hatch Call.vi/Rising Edge Plate/error in</Property>
	<Property Name="varPersistentID:{9BB20562-7D51-4F19-9EFA-803FAC4E47AD}" Type="Ref">/Target/Hatch/Hatch Call.vi/Falling Edge Plate/error in</Property>
	<Property Name="varPersistentID:{B13AE2D9-7378-43F6-950F-A5FAC70FDBF6}" Type="Ref">/Target/Hatch/Hatch Call.vi/Rising Edge Plate/error out</Property>
	<Property Name="varPersistentID:{B1F7BF30-0349-4F04-8C00-A0F12F23648F}" Type="Ref">/Target/Hatch/Hatch Call.vi/Falling Edge Plate/error out</Property>
	<Property Name="varPersistentID:{B7463FA8-AE49-45FA-BF9D-D36B325B8046}" Type="Ref">/Target/Drive/Drive Call.vi/One Shot Rising with Input 0/error out</Property>
	<Property Name="varPersistentID:{C09189E6-0E2B-4925-A2B4-3AEFE22E95DE}" Type="Ref">/Target/Drive/Drive Call.vi/One Shot Rising with Input  180/error out</Property>
	<Property Name="varPersistentID:{C99A886D-805A-4D32-90C1-E792BBA1F344}" Type="Ref">/Target/Hatch/Hatch Call.vi/Falling Edge Gripper/error in</Property>
	<Property Name="varPersistentID:{DFCBEAF5-876D-4685-880F-3E3295F9611B}" Type="Ref">/Target/Hatch/Hatch Call.vi/Falling Edge Plate/input</Property>
	<Property Name="varPersistentID:{E6F63D33-7C99-4733-89B6-5129052FB655}" Type="Ref">/Target/Drive/Drive Call.vi/One Shot Rising with Input 90/error in</Property>
	<Property Name="varPersistentID:{E74660B4-D2A3-4B2D-B812-246CBAAC9D76}" Type="Ref">/Target/Drive/Drive Call.vi/One Shot Rising with Input 270 /input</Property>
	<Property Name="varPersistentID:{E90F307A-AD96-49DB-850E-13FE77F2BA40}" Type="Ref">/Target/Drive/Drive Call.vi/One Shot Rising with Input 270 /output</Property>
	<Property Name="varPersistentID:{EF130112-E3EE-4F3E-B691-86AC92C341BD}" Type="Ref">/Target/Drive/Drive Call.vi/One Shot Rising with Input  180/output</Property>
	<Property Name="varPersistentID:{F93179FF-C3D7-4458-9DAF-7076BC84AD66}" Type="Ref">/Target/Drive/Drive Call.vi/One Shot Rising with Input  180/input</Property>
...
AddOutputFilter chunkFilter
		...
		<Item Name="Hatch" Type="Folder" URL="../Hatch">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="Intake Cargo" Type="Folder" URL="../Intake Cargo">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="Shoulder" Type="Folder" URL="../Shoulder">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="Elbow" Type="Folder" URL="../Elbow">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
